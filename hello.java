...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta content="https://avatars3.githubusercontent.com/u/36693629?s=400&amp;v=4" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="poshankk/box-office" property="og:title" /><meta content="https://github.com/poshankk/box-office" property="og:url" /><meta content="Contribute to box-office development by creating an account on GitHub." property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjUxMzk2NDgyOjI4NWIwZDBhZjIzN2FhNGMxMTcyZjkxYjkwOWNkNjNkMDZhNTNjZTcxMWRkNzg0N2EzNDk2M2QzNDk5Zjk3OGQ=--a968c74d7943ca2136faba3e28a3af044d700811">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="C0CE:1E96E:6104A4:C2CDAD:5A8D371B" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="C0CE:1E96E:6104A4:C2CDAD:5A8D371B" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="36693629" name="octolytics-actor-id" /><meta content="poshankk" name="octolytics-actor-login" /><meta content="4c707ae8e8b367788fb29e1291e798b512283ce243ae2b745471ea90f52467b2" name="octolytics-actor-hash" />
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/new" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="poshankk">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="ODk3Mzk5NzM4YzBhMzEwMzI2NzA3MzI2ODBjZmQ4NThkMjEyYjBiYmRjMGU0NmI2NzMxM2FhOTA1NmY3OWRjZXx7InJlbW90ZV9hZGRyZXNzIjoiMTQuMTM5LjYxLjIwMSIsInJlcXVlc3RfaWQiOiJDMENFOjFFOTZFOjYxMDRBNDpDMkNEQUQ6NUE4RDM3MUIiLCJ0aW1lc3RhbXAiOjE1MTkyMDQxMjUsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="12aca7e73ff158976c221442d07423dd8992094d">

  <meta http-equiv="x-pjax-version" content="753d2cf526759388e487b4fe2219dad2">
  

      <link href="https://github.com/poshankk/box-office/commits/master.atom" rel="alternate" title="Recent Commits to box-office:master" type="application/atom+xml">

  <meta name="description" content="Contribute to box-office development by creating an account on GitHub.">
  <meta name="go-import" content="github.com/poshankk/box-office git https://github.com/poshankk/box-office.git">

  <meta content="36693629" name="octolytics-dimension-user_id" /><meta content="poshankk" name="octolytics-dimension-user_login" /><meta content="122313491" name="octolytics-dimension-repository_id" /><meta content="poshankk/box-office" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="122313491" name="octolytics-dimension-repository_network_root_id" /><meta content="poshankk/box-office" name="octolytics-dimension-repository_network_root_nwo" /><meta content="true" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/poshankk/box-office/search" class="js-site-search-form" data-scoped-search-url="/poshankk/box-office/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/poshankk/box-office/new/master" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="poshankk/box-office">This repository</span>
  </div>
    <a class="dropdown-item" href="/poshankk/box-office/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@poshankk" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/36693629?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">poshankk</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/poshankk" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/poshankk?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="6YHj2IkKpfzbmNj5qO5e2KP/iO5yoMLNNBZf3e6PwoqI7JyoDAZ4EHLjX0KWTsahUC+sRo3yctw8ilc534B9iw==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="LiNvn47MMnhNxexwZQJCwwvAeVDfgENUQDlmWA+Tv9lPThDvC8DvlOS+a8tbotq6+BBd+CDS80VIpW68PpwA2A==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="hrCySG9sLsKQb2JLTf/JNRzYkzRFJULHXTpfSnPP5udgGNWyYRzYQLwOEBE+A+YtMw/uy98HK4WCPlYyFk2CCQ==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="122313491" />

        <div class="select-menu js-menu-container js-select-menu">
          <a href="/poshankk/box-office/subscription"
          ...
          <a class="social-count js-social-count"
            href="/poshankk/box-office/watchers"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/poshankk/box-office/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="fCbR1eRvMevqH3Ac3Wgcm3kSxCjrf2Er8yD9CueTx3AzOghhQkYiOmElYa0fc+z3Dhj6iVlMLM6GK6s0yrT8+A==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Unstar this repository" title="Unstar poshankk/box-office"
        data-ga-click="Repository, click unstar button, action:blob#new; text:Unstar">
        <svg aria-hidden="true" class="octicon octicon-star" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/></svg>
        Unstar
      </button>
        <a class="social-count js-social-count" href="/poshankk/box-office/stargazers"
           aria-label="0 users starred this repository">
          0
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/poshankk/box-office/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="tVtyKly5qMkhZb4hGwu82fEy8JWLfkpBeSZ+6lk3WMBKacUqDbHKuSiRx+RMmq8vzHEraYyleCGM6ypaHGRePQ==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Star this repository" title="Star poshankk/box-office"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/poshankk/box-office/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="nRNxE+wBmqW5cRCXQXHt5uYMilFODva9O5n0BtMV7GbsP4gXqx+2tiPMqjHK5lHiZx0lZdR9bVqDpJQWtp/rzg==" /></div>
            <button
                type="submit"
                class="btn btn-sm btn-with-count"
                data-ga-click="Repository, show fork modal, action:blob#new; text:Fork"
                title="Fork your own copy of poshankk/box-office to your account"
                aria-label="Fork your own copy of poshankk/box-office to your account">
              <svg aria-hidden="true" class="octicon octicon-repo-forked" height="16" version="1.1" viewBox="0 0 10 16" width="10"><path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"/></svg>
              Fork
            </button>
</form>
    <a href="/poshankk/box-office/network" class="social-count"
  ...
  <span class="author" itemprop="author"><a href="/poshankk" class="url fn" rel="author">poshankk</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a href="/poshankk/box-office" data-pjax="#js-repo-pjax-container">box-office</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/poshankk/box-office" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /poshankk/box-office" itemprop="url">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a href="/poshankk/box-office/issues" class="js-selected-navigation-item reponav-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /poshankk/box-office/issues" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/poshankk/box-office/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls checks /poshankk/box-office/pulls" itemprop="url">
    ...
    <a href="/poshankk/box-office/projects" class="js-selected-navigation-item reponav-item" data-hotkey="g b" data-selected-links="repo_projects new_repo_project repo_project /poshankk/box-office/projects">
      <svg aria-hidden="true" class="octicon octicon-project" height="16" version="1.1" viewBox="0 0 15 16" width="15"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
      Projects
      <span class="Counter" >0</span>
</a>
    <a href="/poshankk/box-office/wiki" class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /poshankk/box-office/wiki">
      <svg aria-hidden="true" class="octicon octicon-book" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/></svg>
      Wiki
</a>

  <a href="/poshankk/box-office/pulse" class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /poshankk/box-office/pulse">
    <svg aria-hidden="true" class="octicon octicon-graph" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M16 14v1H0V0h1v14h15zM5 13H3V8h2v5zm4 0H7V3h2v10zm4 0h-2V6h2v7z"/></svg>
    Insights
</a>
    <a href="/poshankk/box-office/settings" class="js-selected-navigation-item reponav-item" data-selected-links="repo_settings repo_branch_settings hooks integration_installations repo_keys_settings /poshankk/box-office/settings">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <div class="file-box">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/poshankk/box-office/preview/master" class="d-none js-blob-preview-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Xd1kNEBwlhz8Y87Lbjr7f4gdatwkcrdWOe4Y25JMlidldfAK1kPd9Kr/6kAtlYv40MBJ3DbekTfDOdpyqDh9FA==" /></div>
...
</form>    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/poshankk/box-office/create/master" class="js-blob-form" data-github-confirm-unload="Your new changes will be lost." method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="a2XdU+24LG1UBe82YbwnAWKUCIHCFtYSkMvFptkWMF/kQebd7G2UCtZtVClHrTraMZOh22Dv2RZWiuKcAUJf6Q==" /></div>
  ...
  <div class="select-menu-modal-holder select-menu-git-ignore js-menu-content js-navigation-container">
    ...
    <div class="select-menu-modal">
      ...
      <div class="editor-license-template js-license-template js-template-suggestion d-none" data-template-suggestion-pattern="^(.+\/)?(licen[sc]e|copying)($|\.)">
          <a class="btn btn-sm" data-template-button href="/poshankk/box-office/community/license/new?branch=master">Choose a license template</a>
      </div>
      <div class="editor-code-of-conduct-template js-template-suggestion d-none" data-template-suggestion-pattern="^(code.?of.?conduct|coc)($|\.)">
        <a class="btn btn-sm" data-template-button href="/poshankk/box-office/community/code-of-conduct/new">Choose a code of conduct template</a>
      </div>

    <span class="js-breadcrumb-container">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/poshankk/box-office" data-pjax="true"><span>box-office</span></a></span></span><span class="separator">/</span>
    ...
    <span class="editor-abort">or <a href="/poshankk/box-office">cancel</a></span>
...
<input type="hidden" name="commit" class="js-commit-oid" value="ca08cca3ced2df0ae054eddeba94ebd52478bc09">
...
<div class="file-commit-form js-file-commit-form">
  <img alt="@poshankk" class="commit-form-avatar float-left rounded-1" height="48" src="https://avatars0.githubusercontent.com/u/36693629?s=96&amp;v=4" width="48" />
...
<div class="ml-6 js-quick-pull-branch-name mt-2 d-none">
  <div class="position-relative mt-2 ml-2">
    ...
    <input type="text" value="poshankk-patch-1"
      ...
      data-generated-branch="poshankk-patch-1"
      data-check-url="https://github.com/poshankk/box-office/ref_check"
      data-check-authenticity-token="+HHKAuV+RSoooiHszPCQtJcMdMV8X/4qnmGfrtD3c0+GQKpCmpdw3gktfD4FVHlHA6W1FLSlxo3QIXtO1UeBeA==">
...
<input type="hidden" name="quick_pull" class="js-quick-pull-choice-value" value="">
  ...
  <a href="/poshankk/box-office" class="btn btn-danger">Cancel</a>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.18004s from unicorn-2235343889-2p4j3">GitHub</span>, Inc.</li>
  ...
  <div id="ajax-error-message" class="ajax-error-message flash flash-error">
    ...
    <script async="async" crossorigin="anonymous" integrity="sha512-WWSCoq8vnwIxQwOKjcFAaXbfRzaPAewYwu/N/98yZEhF8C622SebLjU8Tx0InYjYGjd60VIbv8r1LDNal9K8Tw==" src="https://assets-cdn.github.com/assets/github-596482a2af2f.js" type="application/javascript"></script>
        ...
        <script crossorigin="anonymous" integrity="sha512-7TKLhnsRNmwvqs2cl74bTPSr5S6IHoCOY1hyfX5nMJkJq8KacTGDe4CXVJ7Kj+ukngRh9RwGUXZKXQcIoVdDkw==" src="https://assets-cdn.github.com/assets/editor-ed328b867b11.js" type="application/javascript"></script>
